...
const APPLICATIONS=[
  ...
  {code:'CTET',name:'CTET',cat:'Teaching',status:'open',popularity:11,hi:{name:'सीटीईटी'},
    ...
    verified:'26 Aug 2026'},
  {code:'UP-POLICE-CONST',name:'UP Police Constable',cat:'Police',status:'closed',popularity:22,hi:{name:'यूपी पुलिस कांस्टेबल'},
    ...
    details:{
      dataNote:'(1) This is the most recent UP Police Constable (Civil Police and equivalent — PAC/Armed Police, Special Security Force, Mounted Police, Jail Warder, Female Constable) direct recruitment cycle, notified 31 Dec 2025 by UPPRPB (Uttar Pradesh Police Recruitment and Promotion Board, uppbpb.gov.in). Application window closed 30 Jan 2026 (fee till 02 Feb 2026), so status is "closed" for fresh applications — however the recruitment PROCESS is still running: the written exam (PBT) was held 8–10 June 2026, and the official site (uppbpb.gov.in) shows active notices dated 10 Aug 2026 about Document Verification / Physical Standard Test (DV/PST) admit cards, meaning the cycle is currently at the DV/PST stage as of this verification date. (2) Vacancy count (32,679) and the 31 Dec 2025 / 8–10 Jun 2026 dates are corroborated across many secondary/coaching sites (Testbook, Careers360, Oliveboard, PW Live, CareerPower) but the official notification PDF itself could not be directly retrieved in this pass — treat exact figures as secondary-sourced pending direct PDF confirmation. (3) Applicant-volume figures (the 40–60 lakh scale this exam is known for) could NOT be confirmed for this specific 2026 cycle — no official or secondary figure was found reporting total applications received. For context only: the prior UP Police Constable cycle (2023–24, 60,244 posts) was widely reported in the press as having received roughly 48 lakh applications — that number belongs to the PREVIOUS cycle, not this one, and is coaching/news-site reporting, not an official UPPRPB release. (4) Age-limit figures below show some inconsistency across secondary sources on how the state government\'s additional 3-year relaxation (announced ~5 Jan 2026 per India TV News/Careers360 reporting) compounds with existing SC/ST/OBC relaxation — treat the reserved-category upper-age figures as approximate.',
      ...
      promotion:'Standard UP Police constabulary hierarchy — Constable → Head Constable → Assistant Sub-Inspector (ASI) → Sub-Inspector (SI), via departmental promotion/seniority over a career; not independently verified against an official UPPRPB promotion-rules document in this pass.',
      eligibility:{age:'18–22 years (male) / 18–25 years (female) as the base general-category limit as on 01 Jul 2026 per the notification (dated 22 Jan 2026 per secondary reporting) — UP govt separately announced a one-time additional 3-year age relaxation applicable across categories for this cycle. Cutoff and reference date shift every cycle — verify against the live notification.',ageRelax:'SC/ST/OBC candidates get standard reservation-category age relaxation on top of the general limit — secondary sources report resulting upper limits of roughly 18–31 years (male) / 18–34 years (female) for reserved categories after the extra 3-year relaxation is applied, but this compounding was not confirmed against the official PDF, so treat as approximate.',qualification:'Passed Class 12 (Intermediate) or equivalent from a recognized board.'},
  ...
  {code:'IBPS-RRB',name:'IBPS RRB',cat:'Banking',status:'closed',popularity:23,hi:{name:'आईबीपीएस आरआरबी'},
    ...
    verified:'26 Aug 2026'},
  {code:'SSC-JE',name:'SSC JE',cat:'Central Govt',status:'closed',popularity:24,hi:{name:'एसएससी जेई'},
    ...
    details:{
      ...
      promotion:'No promotion timeline is stated by SSC — JE is an entry-level post and career progression (e.g. to Assistant Engineer) is governed independently by each recruiting department\'s own service/promotion rules, not by SSC. Any specific "X years to promotion" figure seen on coaching sites is unverified and should not be treated as official.',
      eligibility:{age:'Not exceeding 30 years as on 01 Jan 2026 for most posts; up to 32 years for CPWD posts (exact department-wise cutoffs are in the official notice)',
  ...
  {code:'EPFO-SSA',name:'EPFO Social Security Assistant',cat:'Central Govt',status:'closed',popularity:25,hi:{name:'ईपीएफओ एसएसए'},
    ...
    officialUrl:'https://www.epfindia.gov.in/site_docs/PDFs/Recruitments_PDFs/Advertisement_for_SSA_24032023.pdf',
    ...
    details:{
      ...
      promotion:'No promotion timeline is stated in the SSA advertisement; no verified official schedule for progression from SSA was found — do not treat any specific figure from secondary sources as confirmed.',
    ...
    verified:'26 Aug 2026'},
  {code:'RBI-ASSISTANT',name:'RBI Assistant',cat:'Banking',status:'closed',popularity:26,hi:{name:'आरबीआई सहायक'},
    notifTitle:'Recruitment for the post of Assistant — Panel Year 2025, 650 vacancies across RBI offices. Application window 16 Feb – 08/09/10 Mar 2026 (exact extended date disputed across secondary sources, see dataNote).',
    applyStart:'16 Feb 2026',applyEnd:'closed (secondary sources report the extended deadline inconsistently as 08, 09 or 10 Mar 2026 — not independently reconciled against the primary notification this pass)',
    ...
    details:{
      ...
      promotion:'Not addressed in any source reviewed this pass — no promotion-timeline claim is made.',
  ...
  {code:'IB-ACIO',name:'IB ACIO',cat:'Central Govt',status:'closed',popularity:27,hi:{name:'आईबी एसीआईओ'},
    ...
    details:{
      dataNote:'(1) IB ACIO Grade-II/Executive is recruited directly by MHA/IB via mha.gov.in (applications were also routed through www.ncs.gov.in) — NOT by SSC. This is distinct from a separate, smaller "ACIO Grade-II/Technical" recruitment (2025 cycle: 258 posts) that MHA ran on a different notification around the same period; do not conflate the two. (2) The exact PDF filename for the Executive-post 2025 notification could not be independently retrieved via search (only the Technical-post PDF link was found); officialUrl above is the MHA domain root — check mha.gov.in\'s recruitment/notification section directly for the canonical document. (3) As flagged in the task brief, IB ACIO notification timing is historically irregular (multi-year gaps between cycles have occurred); this 2025 cycle is the most recent one found and its process is essentially complete (final result 3 Jun 2026), so there is currently no open/upcoming IB ACIO cycle known as of 26 Aug 2026 — do not infer a new cycle is imminent.',
      ...
      promotion:'No official promotion timeline was found in secondary coverage of the notification; do not present any promotion schedule as officially confirmed.',
      eligibility:{age:'18–27 years as on the closing date (some secondary sources state 20–28; the 18–27 figure appears more consistently across sources but neither range was cross-checked against the primary PDF — flagged as unverified)',
